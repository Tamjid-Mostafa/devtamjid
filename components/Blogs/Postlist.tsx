    ...
    <>
      <div
        className={cn(
          ...
          minimal &&
            'grid md:grid-cols-2 gap-5 md:gap-10 fit bg-accent-1'
        )}
      >
        <div
          className={cn(
            ...
            minimal
              ? ''
              : 'overflow-hidden rounded-md transition-all hover:scale-105'
          )}
        >
          <Link
            className={cn(
            ...
            href={`/blogs/${pathPrefix ? `${pathPrefix}/` : ''}${
              post.slug.current
            }`}
          >
            {imageProps ? (
        ...
        <div className={cn(minimal && 'self-center px-5 pb-10')}>
          <div>
            ...
            >
              ...
              >
                <span
                  className="bg-gradient-to-r from-hover-1 to-hover bg-[length:0px_3px] bg-left-bottom
      bg-no-repeat
      ...
      dark:from-purple-800 dark:to-purple-900"
            ...
            <div className="mt-3 flex items-center space-x-3 text-accent-5">
              ...
              <span className="text-xs text-accent-6">
                &bull;
              </span>
              <time
